...
export interface SwisstronikInterface extends Interface {
...
export interface Swisstronik extends BaseContract {
  connect(runner?: ContractRunner | null): Swisstronik;
  waitForDeployment(): Promise<this>;

  interface: SwisstronikInterface;
