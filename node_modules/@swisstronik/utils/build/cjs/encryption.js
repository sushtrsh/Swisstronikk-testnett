...
function encryptECDH(privateKey, nodePublicKey, data) {
    try {
        ...
        const encryptionKey = deriveEncryptionKey(sharedSecret, (0, utils_1.stringToU8a)(exports.TX_KEY_PREFIX));
        // Encrypt data
        ...
        return { result: (0, utils_1.u8aConcat)(userPublicKey, encryptionResult.result) };
    }
    catch (e) {
        if (typeof e === 'string') {
            return { error: e };
...
function encrypt(privateKey, data) {
    try {
        ...
        const encryptedData = (0, utils_1.u8aConcat)(nonce, ad, ciphertext);
