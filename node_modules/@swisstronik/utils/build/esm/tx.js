 ...
 */
export async function encryptDataField(nodeURL, data, userEncryptionKey) {
 ...
 */
export async function decryptNodeResponse(nodeURL, encryptedResponse, encryptionKey) {
    // Create encryption key using KDF
